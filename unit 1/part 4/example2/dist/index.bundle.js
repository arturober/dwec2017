...
var _personClass = __webpack_require__(2);
...
var _persons = __webpack_require__(28);

var _persons2 = _interopRequireDefault(_persons);

function _interopRequireDefault(obj) { return obj && obj.__esModule ? obj : { default: obj }; }

var p = new _personClass.Person("Peter", 23);
var p2 = new _personClass.Person("Mary", 45);
console.log(p.toString());
console.log(p2.toString());

var persons = [p, p2, new _personClass.Person("Mary", 34), new _personClass.Person("Lucy", 25)];

var tbody = document.querySelector("#persons tbody");
tbody.innerHTML = (0, _persons2.default)({ persons: persons });
// persons.forEach(p => {
...
module.exports = (Handlebars["default"] || Handlebars).template({"1":function(container,depth0,helpers,partials,data) {
  ...
  return ((stack1 = helpers.each.call(depth0 != null ? depth0 : (container.nullContext || {}),(depth0 != null ? depth0.persons : depth0),{"name":"each","hash":{},"fn":container.program(1, data, 0),"inverse":container.noop,"data":data})) != null ? stack1 : "");
},"useData":true});
